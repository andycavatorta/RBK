...
def main():
    ...
    try:
        ...
        print "stty=", repr(commands.getstatusoutput("stty -F /dev/ttyAMA0"))
        #commands.getstatusoutput("stty -F /dev/ttyAMA0 9600 isig icanon iexten echo echoe echok echoctl echoke opost icrnl")
