        ...
        class Channel(threading.Thread):
            ...
            def sendStateToFPGA(self, freq_b, ds_b):
                ...
                if freq_b:
                    ...
                    x24bitParallelPort.send(list("%s%s%s1" % (modeSelector_bin_str, channel_bin_str, osc_bin_str)))
                ...
                if ds_b:
                    ...
                    dutyCycle_bin_str = "1111111" if self.dutyCycle > 99 else '{0:06b}'.format(int((self.dutyCycle*0.64)+0.5))[::-1]
                    print dutyCycle_bin_str
                    # print channel_bin_str
                    # print int((self.dutyCycle*0.64)+0.5)
                    # print int((self.dutyCycle*0.32)-1)
                    padding_bin_str = "000000000001"
