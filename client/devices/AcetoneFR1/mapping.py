...
mapping = {
    ...
    "_general/sound/snare_drum1/bang":(
        ("pulse", {"channel":5, "function": "pulse", "pulselength":0.25 })
    ),
    ...
    "_general/sound/cowbell/bang":(
        ("pulse", {"channel":19, "function": "pulse", "pulselength":0.25 })
    ),
    ...
    "_general/sound/claves/bang":(
        ("pulse", {"channel":21, "function": "pulse", "pulselength":0.25 })
    ),
    ...
    "_general/sound/maracas/bang":(
        ("pulse", {"channel":23, "function": "pulse", "pulselength":0.25,})
    ),
