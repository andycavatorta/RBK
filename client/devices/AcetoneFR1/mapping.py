...
mapping = {
    "_general/sound/bass_drum/bang":(
        ("pulse", {"channel":15, "function": "pulse", "pulselength":0.25 })
    ),
    ...
    "_general/sound/snare_drum1/bang":(
        ("pulse", {"channel":3, "function": "pulse", "pulselength":0.25 })
    ),
    ...
    "_general/sound/snare_drum2/bang":(
        ("pulse", {"channel":6, "function": "pulse", "pulselength":0.25 })
    ),
    ...
    "_general/sound/high_bongo/bang":(
        ("pulse", {"channel":9, "function": "pulse", "pulselength":0.25 })
    ),
    ...
    "_general/sound/low_bongo/bang":(
        ("pulse", {"channel":8, "function": "pulse", "pulselength":0.25 })
    ),
    ...
    "_general/sound/low_conga/bang":(
        ("pulse", {"channel":7, "function": "pulse", "pulselength":0.25 })
    ),
    ...
    "_general/control_change/Main_volume":(
        ("square_wave", {"channel":2, "function": "square_wave", "frequency":30000})
    ),
    ...
    "_general/control_change/clock":(
        ("square_wave", {"channel":14, "function": "square_wave", "frequency":40})
    ),
