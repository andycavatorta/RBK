...
mapping = {
    ...
    "/sound/pedal_hihat/bang":(
        ("MIDI", {"channel":1, "pitch":44, "status":"note_on"})
    ),
    "/sound/pedal_hihat/off":(
    ...
    "/sound/maracas/bang":(
        ("MIDI", {"channel":1, "pitch":70, "status":"note_on"})
    ),
    "/sound/maracas/off":(
        ("MIDI", {"channel":1, "pitch":70, "status":"note_off"})
    ),

    "/sound/short_whistle/bang":(
        ("MIDI", {"channel":1, "pitch":71, "status":"note_on"})
    ),
    "/sound/short_whistle/off":(
        ("MIDI", {"channel":1, "pitch":71, "status":"note_off"})
    ),

    "/sound/long_whistle/bang":(
        ("MIDI", {"channel":1, "pitch":72, "status":"note_on"})
    ),
    "/sound/long_whistle/off":(
        ("MIDI", {"channel":1, "pitch":72, "status":"note_off"})
    ),

    "/sound/short_guiro/bang":(
        ("MIDI", {"channel":1, "pitch":73, "status":"note_on"})
    ),
    "/sound/short_guiro/off":(
        ("MIDI", {"channel":1, "pitch":73, "status":"note_off"})
    ),

    "/sound/long_guiro/bang":(
        ("MIDI", {"channel":1, "pitch":74, "status":"note_on"})
    ),
    "/sound/long_guiro/off":(
        ("MIDI", {"channel":1, "pitch":74, "status":"note_off"})
    ),
    ...
    "/sound/high_woodblock/bang":(
        ("MIDI", {"channel":1, "pitch":76, "status":"note_on"})
    ),
    "/sound/high_woodblock/off":(
        ("MIDI", {"channel":1, "pitch":76, "status":"note_off"})
    ),
    ...
    "/sound/mute_cuica/bang":(
        ("MIDI", {"channel":1, "pitch":78, "status":"note_on"})
    ),
    "/sound/mute_cuica/off":(
        ("MIDI", {"channel":1, "pitch":78, "status":"note_off"})
    ),

    "/sound/open_cuica/bang":(
        ("MIDI", {"channel":1, "pitch":79, "status":"note_on"})
    ),
    "/sound/open_cuica/off":(
        ("MIDI", {"channel":1, "pitch":79, "status":"note_off"})
    ),

    "/sound/mute_triangle/bang":(
        ("MIDI", {"channel":1, "pitch":80, "status":"note_on"})
    ),
    "/sound/mute_triangle/off":(
        ("MIDI", {"channel":1, "pitch":80, "status":"note_off"})
    ),

    "/sound/open_triangle/bang":(
        ("MIDI", {"channel":1, "pitch":81, "status":"note_on"})
    ),
