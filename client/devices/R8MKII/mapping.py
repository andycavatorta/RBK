...
mapping = {
    ...
    "_general/sound/chinese_cymbal/bang":(
        ("MIDI", {"channel":1, "pitch":52, "status":"note_on"})
    ),
    "_general/sound/chinese_cymbal/off":(
    ...
    "_general/sound/vibra_slap/bang":(
        ("MIDI", {"channel":1, "pitch":58, "status":"note_on"})
    ),
    "_general/sound/vibra_slap/off":(
        ("MIDI", {"channel":1, "pitch":58, "status":"note_off"})
    ),

    "_general/sound/ride_cymbal2/bang":(
        ("MIDI", {"channel":1, "pitch":59, "status":"note_on"})
    ),
    "_general/sound/ride_cymbal2/off":(
    ...
    "_general/sound/high_woodblock/off":(
